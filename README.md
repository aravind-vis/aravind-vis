...
- **Platform Concerns**: Infrastructure migration & modernization, container security and
  runtime protection  
- **Data**: Relational-first design, PostgreSQL sharding & partitioning, MongoDB for
  configuration and operational data, pragmatic polyglot persistence  
